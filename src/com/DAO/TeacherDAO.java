...
public class TeacherDAO extends BaseHibernateDAO {
	...
	public Teacher findById(java.lang.String id) {
		...
		try {
			Teacher instance = (Teacher) getSession().get("com.ORM.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getSession().createCriteria("DAO.Teacher")
	...
	public List findByFacultyName(Object facultyName) {
		return findByProperty(FACULTY_NAME, facultyName);
	}
